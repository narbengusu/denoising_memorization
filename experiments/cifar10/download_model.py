"""Fetch the pretrained pixel-space DDPM CIFAR-10 checkpoint from Hugging Face
and stage it under experiments/cifar10/pretrained/. Run this once before
finetune_cifar10_ddpm.py.
...
point -- finetune_cifar10_ddpm.py does the actual small-subset finetuning that
induces memorization.
"""
import os
